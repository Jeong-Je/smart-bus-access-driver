 ...
 * @brief 운전석 ECU 측 CAN wrapper API
 * @{
 */
...
/**
 * @brief 
 * Open-time configuration for the driver-side door CAN wrapper.
 * 
...
/**
 * @brief 
 * Latest status information received from the door ECU.
 * 
...
/**
 * @brief 
 * Driver-side CAN wrapper for sending commands and tracking door status.
...
/**
 * @brief 
 * Initialize a DriverECUCAN object to its default closed state.
 * 
...
/**
 * @brief 
 * Initialize driver ECU CAN configuration with default values.
 * 
...
/**
 * @brief 
 * Open the driver-side door CAN wrapper.
 * 
...
/**
 * @brief 
 * Close the driver-side door CAN wrapper.
 * 
...
/**
 * @brief 
 * Pack and send one command frame to the door ECU.
 * 
 ...
 *
 * @retval CAN_STATUS_EINVAL
 * invalid argument or invalid command field value.
...
/**
 * @brief 
 * Poll for one status frame and update the cached snapshot when received.
 ...
 *
 * @param updated 
 * Optional output that becomes true when a new status frame is consumed.
...
/**
 * @brief 
 * Get the cached door-status snapshot.
 * 
 ...
 *
 * @return 
 * Pointer to the cached status snapshot, or null if the argument is invalid.
...
/**
 * @brief 
 * Check whether the cached status snapshot is still considered alive.
 * 
 ...
 *
 * @return 
 * true if a recent status frame was received within timeout_ms, otherwise false.
