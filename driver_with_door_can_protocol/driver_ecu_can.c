...
static void DriverEcuCanBuildOpenParams(CANSocketOpenParams *params, const DriverECUCANConfig *config)
{
                                  ...
                                  bool reset_fault)
{
    ...
    payload = DriverWithDoorCanPackCommand(door_cmd, ramp_cmd, emergency_stop, reset_fault);
